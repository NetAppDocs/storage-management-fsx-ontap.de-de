...
. <<Erstellen Sie eine Replikationsbeziehung,Erstellen Sie eine Replikationsbeziehung>>, wählen Sie *Migration* als Anwendungsfall und wählen Sie *Speicher-VM-Konfiguration replizieren* aus.
...
.Ergebnis
Nach der Umstellung werden die Quellvolumes gelöscht und die Ziel-Volumes werden lesen/schreiben. Sie können link:https://docs.netapp.com/us-en/workload-fsx-ontap/change-tiering-policy.html["die Tiering-Richtlinie ändern"] für das Ziel-Volume nach der Umstellung.
