...
. <<Cut over replication,Replikation umschalten>>um Daten und Konfigurationseinstellungen dauerhaft vom Quelldateisystem auf das Ziel-FSx for ONTAP-Dateisystem zu migrieren.


Um diese Funktion zu nutzen, erstellen Sie ein
