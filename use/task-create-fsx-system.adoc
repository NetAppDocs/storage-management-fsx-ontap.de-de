...
summary: Erstellen oder entdecken Sie ein FSx für ONTAP -Dateisysteme, um Volumes und zusätzliche Datendienste über die NetApp Konsole hinzuzufügen und zu verwalten. 
---
...
Sie können Ihre FSx for ONTAP Dateisysteme auf verschiedene Weise verwalten, z. B. über Workloads in der NetApp Konsole, mit ONTAP System Manager und mit AWS CloudFormation. Erfahren Sie, wie Sie link:task-manage-fsx-systems.html["Verwalten eines FSx für ONTAP -Dateisystems"] .
...
.Schritte
. Wählen Sie im NetApp -Konsolenmenü *Storage*, dann *Management* und dann *Discoverable systems*.
